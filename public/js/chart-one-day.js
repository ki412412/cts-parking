...
function dummyData() {
  // let response = await axios.get('/parking-c');
  var result = [];
...
new chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart(document.getElementById('myChart'), config);
})();
